...
const appName = 'MoneyFly';
const appHelperService = 'MoneyFlyHelperService';
const coreName = 'clash.meta';
const browserUa =
    'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36';
const packageName = 'com.moneyfly.proxy';
final unixSocketPath = '/tmp/MoneyFlySocket_${Random().nextInt(10000)}.sock';
final windowsPipeName = '\\\\.\\pipe\\MoneyFlyCore_${Random().nextInt(10000)}';
...
const repository = 'moneyfly004/test';
...
const mainIsolate = 'MoneyFlyMainIsolate';

const serviceIsolate = 'MoneyFlyServiceIsolate';
